...
public final class STLLoader {
	...
	public static void loadSTLAsync(final Context parent, URL url, final Object3DBuilder.Callback callback) {
	...
	private static class STLLoaderTask extends LoaderTask {
		...
		STLLoaderTask(Context parent, URL url, Object3DBuilder.Callback callback){
